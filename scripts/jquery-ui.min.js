...
(function (t) {
  ...
  (t.cleanData = (function (e) {
    ...
    (t.Widget.prototype = {
      ...
      _off: function (e, i) {
        (i =
          ...
          e.off(i).off(i),
          (this.bindings = t(
            this.bindings.not(e).get(),
          )),
          (this.focusable = t(
            this.focusable.not(e).get(),
          )),
          (this.hoverable = t(
    ...
    t.each(
      ...
      function (e, i) {
        t.Widget.prototype["_" + e] = function (
          s,
          n,
          o,
        ) {
    ...
    t.widget("ui.mouse", {
      ...
      _mouseDistanceMet: function (t) {
        return (
          Math.max(
            Math.abs(
              this._mouseDownEvent.pageX -
                t.pageX,
            ),
            Math.abs(
              this._mouseDownEvent.pageY -
                t.pageY,
            ),
    ...
    t.widget("ui.sortable", t.ui.mouse, {
        ...
        if (this.dragging) {
          ...
          for (
            ...
            this.containers[e]._trigger(
              ...
              this.containers[e].containerCache
                .over &&
                (this.containers[e]._trigger(
                  "out",
                  null,
      ...
      _intersectsWith: function (t) {
        ...
        return "pointer" ===
          ...
          ? p
          : e + this.helperProportions.width / 2 >
              o &&
              a >
                i -
      ...
      refreshPositions: function (e) {
        ...
        if (
          ...
          this.options.custom.refreshContainers.call(
            this,
          );
        else
          for (
            ...
            (o =
              ...
              (this.containers[
                i
              ].containerCache.left = o.left),
              (this.containers[
                i
              ].containerCache.top = o.top),
              (this.containers[
                i
              ].containerCache.width =
                this.containers[
                  i
                ].element.outerWidth()),
              (this.containers[
                i
              ].containerCache.height =
                this.containers[
                  i
                ].element.outerHeight());
        return this;
      ...
      _contactContainers: function (e) {
        ...
        if (d)
          if (1 === this.containers.length)
            this.containers[p].containerCache
              .over ||
            ...
            for (
              ...
              t.contains(
                ...
                this.items[s].item[0] !==
                  this.currentItem[0] &&
                ((l =
                  this.items[s].item.offset()[a]),
                (h = !1),
                e[u] - l > this.items[s][r] / 2 &&
                  (h = !0),
                n > Math.abs(e[u] - l) &&
                  ((n = Math.abs(e[u] - l)),
                  (o = this.items[s]),
      ...
      _createHelper: function (e) {
        ...
        return (
          ...
          s[0] === this.currentItem[0] &&
            (this._storedCSS = {
              width:
                this.currentItem[0].style.width,
              height:
                this.currentItem[0].style.height,
              position:
                this.currentItem.css("position"),
      ...
      _clear: function (t, e) {
        ...
        for (
          ...
          e ||
            ...
            this.containers[s].containerCache
              .over &&
              (n.push(
                i(
                  "out",
