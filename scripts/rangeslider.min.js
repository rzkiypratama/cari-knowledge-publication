  ...
  function j(b, e) {
    ...
    (this.identifier = "js-" + k + "-" + l++),
      ...
      (this.endEvent =
        ...
        this.identifier),
      (this.toFixed =
        (this.step + "").replace(".", "").length -
        1),
      (this.$fill = a(
        '<div class="' +
          this.options.fillClass +
          '" />',
      )),
      (this.$handle = a(
        '<div class="' +
      ...
      (this.handleDown = a.proxy(
        this.handleDown,
        this,
      )),
      (this.handleMove = a.proxy(
        this.handleMove,
        this,
      )),
      (this.handleEnd = a.proxy(
        this.handleEnd,
        this,
      )),
      this.init();
  ...
  return (
    ...
    (j.prototype.update = function (a, b) {
      (a = a || !1),
        ...
        (this.position =
          this.getPositionFromValue(this.value)),
    ...
    (j.prototype.getPositionFromNode = function (
      a,
    ) {
      for (var b = 0; null !== a; )
    ...
    (j.prototype.getRelativePosition = function (
      a,
    ) {
    ...
    (j.prototype.getPositionFromValue = function (
      a,
    ) {
      var b, c;
      return (
        (b =
          (a - this.min) / (this.max - this.min)),
        (c = Number.isNaN(b)
          ? 0
          : b * this.maxHandlePos)
      );
    }),
    (j.prototype.getValueFromPosition = function (
      a,
    ) {
      var b, c;
      return (
