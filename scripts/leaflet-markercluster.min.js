!(function (e, t) {
  ...
  var t = (L.MarkerClusterGroup =
    L.FeatureGroup.extend({
      options: {
        ...
        clusterPane:
          L.Marker.prototype.options.pane,
        spiderfyOnMaxZoom: !0,
      ...
      initialize: function (e) {
        L.Util.setOptions(this, e),
          ...
          (this._nonPointGroup =
            L.featureGroup()),
          this._nonPointGroup.addEventParent(
            this,
          ),
      ...
      addLayer: function (e) {
        ...
        if (e.__parent)
          for (; t.__parent._zoom >= i; )
            t = t.__parent;
        return (
          this._currentShownBounds.contains(
            t.getLatLng(),
          ) &&
              ...
              for (
                ...
                if (
                  ...
                  if (
                    ...
                    i.__parent &&
                      2 ===
                        i.__parent.getChildCount())
                  ) {
                    var f =
                        i.__parent.getAllChildMarkers(),
                      m =
                        f[0] === i ? f[1] : f[0];
                    n.removeLayer(m);
                  }
      ...
      getBounds: function () {
        ...
        for (
          var t =
            this._needsClustering.length - 1;
          t >= 0;
          t--
        )
          e.extend(
            this._needsClustering[t].getLatLng(),
          );
        return (
          e.extend(
            this._nonPointGroup.getBounds(),
          ),
          e
        );
      },
      eachLayer: function (e, t) {
        ...
        for (
          this._topClusterLevel &&
            this._topClusterLevel.getAllChildMarkers(
              s,
            ),
            n = s.length - 1;
          n >= 0;
      ...
      onAdd: function (e) {
        ...
        for (
          this._featureGroup.addTo(e),
            ...
            this._gridClusters ||
              this._generateInitialClusters(),
            this._maxLat =
              e.options.crs.projection.MAX_LATITUDE,
            t = 0,
        ...
        for (
          t = 0, i = this._needsRemoving.length;
          i > t;
          t++
        )
          (n = this._needsRemoving[t]),
      ...
      fire: function (e, t, i) {
        if (
          t &&
          t.layer instanceof L.MarkerCluster
        ) {
          if (
            t.originalEvent &&
            this._isOrIsParent(
        ...
        L.FeatureGroup.prototype.fire.call(
          this,
          e,
          t,
          i,
      ...
      listens: function (e, t) {
        return (
          L.FeatureGroup.prototype.listens.call(
            this,
            e,
            t,
          ) ||
      ...
      _generateInitialClusters: function () {
        ...
        for (var r = e; r >= t; r--)
          (this._gridClusters[r] =
            new L.DistanceGrid(n(r))),
            (this._gridUnclustered[r] =
              new L.DistanceGrid(n(r)));
        this._topClusterLevel =
      ...
      _addLayer: function (e, t) {
        ...
        for (
          ...
          if ((a = s[t].getNearObject(i))) {
            ...
            r[t].addObject(
              l,
              this._map.project(l._cLatLng, t),
            ),
              (a.__parent = l),
              (e.__parent = l);
            var u = l;
            for (n = t - 1; n > h._zoom; n--)
              (u = new this._markerCluster(
                this,
                n,
                u,
              )),
        ...
        this._processQueue(),
          ...
          this._currentShownBounds.intersects(
            ...
            ? (this._animationStart(),
              ...
              this._animationZoomIn(
                this._zoom,
                e,
              ))
            : this._zoom > e
            ? (this._animationStart(),
              this._animationZoomOut(
                this._zoom,
                e,
              ))
            : this._moveEnd();
      ...
      _getExpandedVisibleBounds: function () {
        return this.options
          ...
          ? L.Browser.mobile
            ? this._checkBoundsMaxLat(
                this._map.getBounds(),
              )
            : this._checkBoundsMaxLat(
                this._map.getBounds().pad(1),
              )
      ...
      _checkBoundsMaxLat: function (e) {
        ...
        return (
          void 0 !== t &&
            (e.getNorth() >= t &&
              (e._northEast.lat = 1 / 0),
            e.getSouth() <= -t &&
              (e._southWest.lat = -1 / 0)),
          e
        );
      },
        ...
        _animationZoomIn: function (e, t) {
          ...
          (this._ignoreMove = !0),
            ...
            this._topClusterLevel._recursively(
              ...
              t,
              function (e) {
                e._recursivelyRestoreChildPositions(
                  t,
                );
              },
            ),
  ...
  var i = (L.MarkerCluster = L.Marker.extend({
    ...
    getAllChildMarkers: function (e, t) {
      e = e || [];
      for (
        var i = this._childClusters.length - 1;
        i >= 0;
        i--
      )
      ...
      for (
        var n = this._markers.length - 1;
        n >= 0;
        n--
      )
        (t && this._markers[n].__dragStart) ||
    ...
    createIcon: function () {
      return (
        this._iconNeedsUpdate &&
          ((this._iconObj =
            this._group.options.iconCreateFunction(
              this,
            )),
    ...
    _addChild: function (e, t) {
      (this._iconNeedsUpdate = !0),
        ...
        e instanceof L.MarkerCluster
          ...
          : (t || this._markers.push(e),
            this._childCount++),
        this.__parent &&
          this.__parent._addChild(e, !0);
    },
            ...
            for (
              ...
              i.contains(s._latlng) &&
                (e &&
                  ...
                  s.clusterHide &&
                    s.clusterHide()),
                n._group._featureGroup.addLayer(
                  s,
                ));
            }
        },
    ...
    _recursivelyRestoreChildPositions: function (
      ...
      if (e - 1 === this._zoom)
        for (
          var n = this._childClusters.length - 1;
          n >= 0;
          n--
        )
          this._childClusters[
        ...
        for (
          var r = this._childClusters.length - 1;
          r >= 0;
          r--
        )
          this._childClusters[
    ...
    _recursivelyRemoveChildrenFromMap: function (
      ...
      this._recursively(
        ...
        function (e) {
          for (
            s = e._markers.length - 1;
            s >= 0;
            s--
          )
            (r = e._markers[s]),
              (n && n.contains(r._latlng)) ||
                (e._group._featureGroup.removeLayer(
                  r,
                ),
    ...
    (function () {
      L.QuickHull = {
        ...
        buildConvexHull: function (e, t) {
          var i = [],
            n =
              this.findMostDistantPointFromBaseLine(
                e,
                t,
              );
          return n.maxPoint
          ...
          void 0 === m &&
            (m =
              L.MarkerClusterGroup.prototype
                .options.spiderLegPolylineOptions
                .opacity),
            p
              ? ((f.opacity = 0),
                (f.className =
        ...
        return (
          e
            ? e instanceof L.MarkerClusterGroup
              ? (e =
                  e._topClusterLevel.getAllChildMarkers())
          ...
          this._refreshClustersIcons(),
          this.options.singleMarkerMode &&
            this._refreshSingleMarkerModeMarkers(
              e,
            ),
          this
        );
    ...
    L.Marker.include({
      refreshIconOptions: function (e, t) {
        ...
        return (
          ...
          t &&
            this.__parent &&
            this.__parent._group.refreshClusters(
              this,
            ),
          this
        );
