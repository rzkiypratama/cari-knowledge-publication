...
!(function (e, t) {
  ...
  function (C, e) {
    ...
    var h = (function (n) {
      ...
      (se.attr = function (e, t) {
        ...
        var n = b.attrHandle[t.toLowerCase()],
          r =
            n &&
            j.call(b.attrHandle, t.toLowerCase())
              ? n(e, t, !E)
              : void 0;
        return void 0 !== r
          ? r
    ...
    (me = E.createDocumentFragment().appendChild(
      ...
      (y.noCloneChecked = !!me.cloneNode(!0)
    ...
    function Ae(e, t, n, r, i, o) {
      ...
      return (
        1 === o &&
          ...
          ((i = function (e) {
            return (
              k().off(e), a.apply(this, arguments)
            );
          }).guid =
                ...
                (c = k.extend(
                  {
                    ...
                    needsContext:
                      i &&
                      k.expr.match.needsContext.test(
                        i,
                      ),
                    namespace: h.join("."),
                  },
    ...
    (k.Animation = k.extend(dt, {
      ...
      (at = E.createElement("select").appendChild(
        E.createElement("option"),
      )),
      (ot.type = "checkbox"),
      (y.checkOn = "" !== ot.value),
      (y.optSelected = at.selected),
      ((ot = E.createElement("input")).value =
        "t"),
      (ot.type = "radio"),
    ...
    k.parseXML = function (e) {
      ...
      return (
        (t &&
          !t.getElementsByTagName("parsererror")
            .length) ||
