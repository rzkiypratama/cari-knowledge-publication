...
(function () {
  ...
  (d = (function () {
    ...
    return (
      ...
      (a.prototype.add_option = function (
        a,
        b,
        c,
      ) {
      ...
      return (
        (a.prototype.set_default_values =
          function () {
            var a = this;
            return (
              (this.click_test_action = function (
                b,
              ) {
        ...
        (a.prototype.results_option_build =
          function (a) {
            var b, c, d, e, f, g, h;
            for (
              b = "",
        ...
        (a.prototype.result_add_group = function (
          a,
        ) {
          var b, c;
          return (a.search_match ||
        ...
        (a.prototype.results_update_field =
          function () {
            if (
              (this.set_default_text(),
              this.is_multiple ||
                ...
                this.include_option_in_results(
                  ...
                  null != b.group_array_index &&
                    ...
                    0 === e.active_options &&
                      ...
                      (d += 1),
                    (e.active_options += 1)),
                  (b.search_text = b.group
                    ? b.label
                    : b.html),
                  (b.group &&
                    !this.group_search) ||
                    ((b.search_match =
                      this.search_string_match(
                        b.search_text,
                        c,
                      )),
                    b.search_match &&
        ...
        (a.prototype.get_search_regex = function (
          a,
        ) {
          var b, c;
          return (
            (b = this.search_contains ? "" : "^"),
            (c = this.case_sensitive_search
              ? ""
              : "i"),
            new RegExp(b + a, c)
          );
        ...
        (a.prototype.choices_click = function (
          a,
        ) {
          if (
            (a.preventDefault(),
        ...
        (a.prototype.keyup_checker = function (
          a,
        ) {
          var b, c;
          switch (
        ...
        (a.prototype.clipboard_event_checker =
          function (a) {
            var b = this;
            return setTimeout(function () {
        ...
        (a.prototype.include_option_in_results =
          function (a) {
            return (
              !(
                this.is_multiple &&
        ...
        (a.prototype.search_results_touchstart =
          function (a) {
            return (
        ...
        (a.prototype.search_results_touchmove =
          function (a) {
            return (
        ...
        (a.prototype.search_results_touchend =
          function (a) {
            if (this.touch_started)
              return this.search_results_mouseup(
                a,
              );
          }),
    ...
    (c = (function (b) {
      function c() {
        return (e = c.__super__.constructor.apply(
          this,
          arguments,
        ));
      }
      return (
        ...
        (c.prototype.setup = function () {
          return (
            (this.form_field_jq = a(
              this.form_field,
            )),
            (this.current_selectedIndex =
              this.form_field.selectedIndex),
            (this.is_rtl =
              this.form_field_jq.hasClass(
                "chosen-rtl",
              ))
          );
        }),
        ...
        (c.prototype.register_observers =
          function () {
            var a = this;
            return (
              this.container.bind(
        ...
        (c.prototype.container_mousedown =
          function (b) {
            if (
              !this.is_disabled &&
              (b &&
        ...
        (c.prototype.container_mouseup =
          function (a) {
            if (
              "ABBR" === a.target.nodeName &&
              !this.is_disabled
            )
              return this.results_reset(a);
          }),
        (c.prototype.search_results_mousewheel =
          function (a) {
            var b;
            if (
              (a.originalEvent &&
        ...
        (c.prototype.results_build = function () {
          return (
            ...
            (this.results_data =
              d.select_to_array(this.form_field)),
            this.is_multiple
              ? this.search_choices
        ...
        (c.prototype.result_do_highlight =
          function (a) {
            var b, c, d, e, f;
            if (a.length) {
              if (
                ...
                this.result_highlight.addClass(
                  "highlighted",
                ),
                (d = parseInt(
                ...
                (e = d + f),
                (c =
                  this.result_highlight.position()
                    .top),
                (b =
                  c +
        ...
        (c.prototype.result_clear_highlight =
          function () {
            return (
        ...
        (c.prototype.update_results_content =
          function (a) {
        ...
        (c.prototype.set_label_behavior =
          function () {
            var b = this;
            if (
              ((this.form_field_label =
                this.form_field_jq.parents(
                  "label",
                )),
        ...
        (c.prototype.show_search_field_default =
          function () {
            return this.is_multiple &&
              ...
              ? (this.search_field.val(
                ...
                this.search_field.addClass(
                  "default",
                ))
              : (this.search_field.val(""),
                this.search_field.removeClass(
                  "default",
                ));
          }),
        (c.prototype.search_results_mouseup =
          function (b) {
            var c;
            if (
              ((c = a(b.target).hasClass(
                "active-result",
              )
                ? a(b.target)
                : a(b.target)
        ...
        (c.prototype.search_results_mouseover =
          function (b) {
            var c;
            if (
              (c = a(b.target).hasClass(
        ...
        (c.prototype.search_results_mouseout =
          function (b) {
            if (
              a(b.target).hasClass(
                "active-result",
            ...
            b.disabled
              ...
              : ((d = a("<a />", {
                ...
                d.bind(
                  "click.chosen",
                  function (a) {
                    return e.choice_destroy_link_click(
                      a,
                    );
                  },
                ),
        ...
        (c.prototype.choice_destroy_link_click =
          function (b) {
            if (
              (b.preventDefault(),
              b.stopPropagation(),
        ...
        (c.prototype.choice_destroy = function (
          a,
        ) {
          if (
        ...
        (c.prototype.results_reset = function () {
          if (
            ...
            (this.form_field.options[0].selected =
              !0),
            this.single_set_selected_text(),
            this.show_search_field_default(),
            this.results_reset_cleanup(),
        ...
        (c.prototype.result_select = function (
          a,
        ) {
          var b, c;
        ...
        (c.prototype.single_set_selected_text =
          function (a) {
            return (
              null == a &&
                (a = this.default_text),
        ...
        (c.prototype.result_deselect = function (
          a,
        ) {
          var b;
          return (
        ...
        (c.prototype.single_deselect_control_build =
          function () {
            if (this.allow_single_deselect)
              return (
                this.selected_item.find("abbr")
                  .length ||
                  this.selected_item
                    .find("span")
                    .first()
        ...
        (c.prototype.get_search_text =
          function () {
            return a("<div/>")
              .text(
                a.trim(this.search_field.val()),
              )
              .html();
          }),
        (c.prototype.winnow_results_set_highlight =
          function () {
            var a, b;
            if (
              ((b = this.is_multiple
        ...
        (c.prototype.keydown_backstroke =
          function () {
            var a;
        ...
        (c.prototype.keydown_checker = function (
          a,
        ) {
          var b, c;
          switch (
        ...
        (c.prototype.search_field_scale =
          function () {
