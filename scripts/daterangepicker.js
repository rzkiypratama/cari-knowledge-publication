  ...
  var a = function (a, i, s) {
      ...
      "object" == typeof i.locale &&
        ...
        "string" == typeof i.locale.weekLabel &&
          (this.locale.weekLabel =
            i.locale.weekLabel),
        "string" ==
          typeof i.locale.customRangeLabel))
    ) {
      (f =
    ...
    "function" == typeof s && (this.callback = s),
      ...
      this.element.is("button")
        ? this.element.on({
            "click.daterangepicker": e.proxy(
              this.show,
              this,
            ),
            "focus.daterangepicker": e.proxy(
              this.show,
              this,
            ),
  ...
  return (
    (a.prototype = {
      ...
      renderCalendar: function (a) {
        ...
        g > p && (g -= 7),
          u == this.locale.firstDay &&
            (g = p - 6);
        for (
          var y = t([f, m, g, 12, o, h]),
            k = ((D = 0), 0),
            b = 0;
          D < 42;
        ...
        if ("right" != t || this.endDate) {
          ...
          for (
            ...
            var d = a.clone().hour(c),
              m = !1;
            i &&
              d.minute(59).isBefore(i) &&
              (m = !0),
              s &&
                d.minute(0).isAfter(s) &&
                (m = !0),
              c != a.hour() || m
                ? (e += m
                    ? '<option value="' +
          ...
          for (
            ...
            i &&
              d.second(59).isBefore(i) &&
              (m = !0),
              s &&
                d.second(0).isAfter(s) &&
                (m = !0),
              a.minute() != l || m
                ? (e += m
                    ? '<option value="' +
      ...
      show: function (t) {
        this.isShowing ||
          ((this._outsideClickProxy = e.proxy(
            function (t) {
              this.outsideClick(t);
            },
            this,
        ...
        for (var a in this.ranges) {
          if (this.timePicker) {
            ...
            this.startDate.format("YYYY-MM-DD") ==
              this.ranges[a][0].format(
                "YYYY-MM-DD",
              ) &&
            this.endDate.format("YYYY-MM-DD") ==
              this.ranges[a][1].format(
                "YYYY-MM-DD",
              )
          ) {
            (t = !1),
      ...
      timeChanged: function (t) {
        var a = e(t.target).closest(
          ...
          i = a.hasClass("left"),
          s = parseInt(
            a.find(".hourselect").val(),
            10,
          ),
          n = parseInt(
            a.find(".minuteselect").val(),
            10,
          ),
          r = this.timePickerSeconds
            ? parseInt(
                a.find(".secondselect").val(),
                10,
              )
            : 0;
        if (!this.timePicker24Hour) {
