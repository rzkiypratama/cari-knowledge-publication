!(function (a, t) {
  ...
  var o = {
    ...
    ca: {
      touch:
        "Fes servir dos dits per moure el mapa",
      scroll:
    ...
    da: {
      touch:
        "Brug to fingre til at flytte kortet",
      scroll:
    ...
    fil: {
      touch:
        "Gumamit ng dalawang daliri upang iusog ang mapa",
      scroll:
        "Gamitin ang ctrl + scroll upang i-zoom ang mapa",
      scrollMac:
    ...
    gl: {
      touch:
        "Utiliza dous dedos para mover o mapa",
      scroll:
        "Preme Ctrl mentres te desprazas para ampliar o mapa",
      scrollMac:
        "Preme ⌘ e desprázate para ampliar o mapa",
    },
    gu: {
    ...
    lv: {
      touch:
        "Lai pārvietotu karti, bīdiet to ar diviem pirkstiem",
      scroll:
    ...
    no: {
      ...
      scroll:
        "Hold ctrl-tasten inne og rull for å zoome på kartet",
      scrollMac:
    ...
    "pt-PT": {
      touch:
        "Utilize dois dedos para mover o mapa",
      scroll:
    ...
    ro: {
      touch:
        "Folosiți două degete pentru a deplasa harta",
      scroll:
    ...
    sl: {
      touch:
        "Premaknite zemljevid z dvema prstoma",
      scroll:
    ...
    sv: {
      ...
      scroll:
        "Använd ctrl + rulla för att zooma kartan",
      scrollMac:
    ...
    e = L.Handler.extend({
      ...
      _handleTouch: function (a) {
        for (
          ...
          L.DomUtil.hasClass(a.target, t[l]) &&
            (e = !0);
        e
          ? L.DomUtil.hasClass(
              a.target,
        ...
        a.metaKey || a.ctrlKey
          ...
          : (L.DomUtil.addClass(
            ...
            (this._isScrolling = setTimeout(
              ...
              this._map.options
                .gestureHandlingOptions.duration,
            )));
      },
