      ...
      (t[n] = function (t, e, n) {
        ...
        (t[n].prototype = {
                  ...
                  i && !e.hasClass(s.noanimation)
                    ? setTimeout(function () {
                        r.__transitionend(
                          ...
                          r.openPanelStart.call(
                            r,
                          );
                      }, r.conf.openingInterval)
                    : (this.openPanelStart.call(
                        this,
                      ),
                      this.openPanelFinish.call(
                        this,
                      ));
              }
          ...
          _initExtensions: function () {
            ...
            var t = this;
            this.opts.extensions.constructor ===
              Array &&
              (this.opts.extensions = {
                all: this.opts.extensions,
              });
            for (var e in this.opts.extensions)
              (this.opts.extensions[e] = this.opts
                .extensions[e].length
                ? "mm-" +
                  this.opts.extensions[e].join(
                    " mm-",
                  )
                : ""),
        ...
        (t[n].support = {
          ...
          csstransitions: (function () {
            return (
              ...
              "undefined" ==
                typeof Modernizr.csstransitions ||
          ...
          csstransforms: (function () {
            return (
              "undefined" == typeof Modernizr ||
              "undefined" ==
                typeof Modernizr.csstransforms ||
          ...
          csstransforms3d: (function () {
            return (
              "undefined" == typeof Modernizr ||
              "undefined" ==
                typeof Modernizr.csstransforms3d ||
   ...
   */,
      ...
      (t[e].addons[n] = {
        setup: function () {
          if (this.opts[n]) {
            ...
            var l = [i.offcanvas];
            "left" != a.position &&
              l.push(i.mm(a.position)),
              "back" != a.zposition &&
                l.push(i.mm(a.zposition)),
              t[e].support.csstransforms ||
                l.push(i["no-csstransforms"]),
              t[e].support.csstransforms3d ||
              ...
              this.bind(
                ...
                function () {
                  ...
                  this.setPage(r.$page),
                    ...
                    this.$menu[
                      o.menuInsertMethod
                    ](o.menuInsertSelector);
                  var e = window.location.hash;
                  if (e) {
                    var s =
                      this._getOriginalMenuId();
                    s &&
                      s == e.slice(1) &&
                      setTimeout(function () {
                        t.open();
    ...
    (function (t) {
      ...
      (t[e].addons[n] = {
        ...
        (t[e].prototype.__sr_aria = function (
          t,
          e,
          n,
        ) {
