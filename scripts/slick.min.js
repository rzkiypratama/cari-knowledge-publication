...
!(function (a) {
  ...
  (b = (function () {
        ...
        b.slideCount > b.options.slidesToShow
          ? (b.$prevArrow
            ...
            b.htmlExpr.test(
              ...
              b.$prevArrow.prependTo(
                b.options.appendArrows,
              ),
            b.htmlExpr.test(
              b.options.nextArrow,
            ) &&
              b.$nextArrow.appendTo(
                b.options.appendArrows,
              ),
    ...
    (b.prototype.buildOut = function () {
      ...
      (b.$slides = b.$slider
        .children(
          b.options.slide + ":not(.slick-cloned)",
        )
    ...
    (b.prototype.cleanUpSlideEvents =
      function () {
        var b = this;
        b.$list.off(
          "mouseenter.slick",
    ...
    (b.prototype.filterSlides =
      b.prototype.slickFilter =
        function (a) {
          var b = this;
          null !== a &&
    ...
    (b.prototype.getCurrent =
      b.prototype.slickCurrentSlide =
        function () {
          var a = this;
        ...
        b.options.infinite === !0
          ? (b.slideCount >
              ...
              ((b.slideOffset =
                ...
                -1),
              (e =
                d * b.options.slidesToShow * -1)),
            b.slideCount %
              b.options.slidesToScroll !==
              0 &&
              a + b.options.slidesToScroll >
                b.slideCount &&
              b.slideCount >
                b.options.slidesToShow &&
              (a > b.slideCount
          ...
          b.options.centerMode === !0 &&
            ...
            (c =
              b.options.rtl === !0
                ...
                : 0),
            (c +=
              (b.$list.width() - f.outerWidth()) /
              2))),
        c
      );
    }),
    (b.prototype.getOption =
      b.prototype.slickGetOption =
        function (a) {
          var b = this;
          return b.options[a];
        }),
    ...
    (b.prototype.progressiveLazyLoad = function (
      ...
      d.length
        ? ((e = d.first()),
          ...
          (g.src = f))
        : c.$slider.trigger("allImagesLoaded", [
            c,
          ]);
    }),
    ...
    (b.prototype.registerBreakpoints =
      function () {
        var c,
          d,
          e,
    ...
    (b.prototype.resize = function () {
      ...
      a(window).width() !== b.windowWidth &&
        ...
        (b.windowDelay = window.setTimeout(
          function () {
    ...
    (b.prototype.setOption =
      b.prototype.slickSetOption =
        function () {
          var c,
            d,
            e,
          ...
          if (
            ...
            for (d in f)
              if (
                "array" !==
                a.type(b.options.responsive)
              )
                b.options.responsive = [f[d]];
              else {
                for (
                  c =
                    b.options.responsive.length -
                    1;
                  c >= 0;

                )
                  b.options.responsive[c]
                    .breakpoint ===
                    f[d].breakpoint &&
                    b.options.responsive.splice(
                      c,
                      1,
                    ),
                    c--;
    ...
    (b.prototype.setProps = function () {
      ...
      (a.positionProp =
        a.options.vertical === !0
          ? "top"
          : "left"),
        "top" === a.positionProp
          ? a.$slider.addClass("slick-vertical")
          : a.$slider.removeClass(
              "slick-vertical",
            ),
    ...
    (b.prototype.slideHandler = function (
      a,
      b,
      c,
    ) {
    ...
    (b.prototype.unfilterSlides =
      b.prototype.slickUnfilter =
        function () {
          var a = this;
          null !== a.$slidesCache &&
            (a.unload(),
